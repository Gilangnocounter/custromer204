...
const WISH_MESSAGES = [
	"I always be right here by your side❤️‍🩹",
	"I'm so lucky to have you💗",
	"Whenever you feel down, remember I’m always here for you",
	"You’re my safest place",
	"with you, I feel complete",
	"I found my home in you><",
	"with you, I feel whole",
	"out of everyone... my heart choose you"
];
...
function startIntro() {
	...
	setTimeout(() => {
		...
		setTimeout(() => {
			...
			// CUSTOM1
			setTimeout(() => {
				showIntroText('HAPPY BIRTHDAY PRETTY><', false);
